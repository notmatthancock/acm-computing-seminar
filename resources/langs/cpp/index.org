...
#+include: ./src/vector/operator-plus/vector.h :lines "25-27" src cpp -n

also add:

#+include: ./src/vector/operator-plus/vector.h :lines "35-36" src cpp -n

to the list of private declarations in =vector.h=

Next, let's add the implementation of these two functions:

#+include: ./src/vector/operator-plus/vector.cpp :lines "54-67" src cpp -n

#+include: ./src/vector/operator-plus/vector.cpp :lines "82-90" src cpp -n

Note how we create the =result= vector in =operator-plus= as a pointer, and then 
...
#+include: ./src/vector/operator-plus/main.cpp src cpp -n
...
**** COMMENT Overloading ~operator-equal~
