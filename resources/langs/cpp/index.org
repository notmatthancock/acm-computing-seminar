...
#+include: ./vector/operator=/vector.h :lines "15-18" src cpp -n
...
can now use the overloaded operator just like how we used the =element= 
function before:

#+include: ./vector/operator=/main.cpp :lines "7-10" src cpp -n
...
#+include: ./vector/operator=/main.cpp
#+begin_src cpp -n
  vec::vector w(14);
  w = v;
  w.print();
