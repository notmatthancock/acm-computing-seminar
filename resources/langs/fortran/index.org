...
\end{cases}
\end{equation*}
for \(n\geq1\). It is an open conjecture whether the hailstone sequence of any initial value \(a_1\) converges to the periodic sequence \(1, 4, 2, 1, 4, 2,\ldots\). Luckily, it does for \(a_1=6\) and the following =do while= loop exits.
...
#+RESULTS[6032635a8b593603d4f586b8684e1925330b3662]:
: count:  1, a:  3
: count:  2, a: 10
: count:  3, a:  5
: count:  4, a: 16
